...
{	
	...
	else if (ast_node->node_type == "COMPARE")
	{
		...
		{
			command = "cmpr "+  right_code_object->result_register  + " " + left_code_object->result_register;
		}
		...
		if (ast_node->value == "=") 
		{
			command = "jne " + else_label;
		}
		else if (ast_node->value == "!=") 
		{
			command = "jeq " + else_label;
		}
		else if (ast_node->value == ">") 
		{
			command = "jle " + else_label;
		}
		else if (ast_node->value == ">=") 
		{
			command = "jlt " + else_label;
		}
		else if (ast_node->value == "<") 
		{
			command = "jge " + else_label;
		}
		else if (ast_node->value == "<=") 
		{
			command = "jgt " + else_label;
		}
		
		current_code_object->instructions.push_back(command);
		current_code_object->result_register = else_label;
		current_code_object->result_type = after_else_label;
